            ...
            <table id="teacherTable"
                ...
                <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                    @foreach ($teachers as $teacher)
                        <tr class="teacher-row hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:shadow-inner transition-all cursor-pointer"
                            data-id="{{ $teacher->id }}">
                            ...
                            <td class="px-4 py-4 text-gray-700 dark:text-gray-400">{{ $teacher->subject->name ?? '-' }}</td>
                            <td class="px-4 py-4 text-gray-700 dark:text-gray-400">{{ $teacher->email }}</td>
                            <td class="px-4 py-4 max-w-[250px] truncate text-gray-700 dark:text-gray-400" title="{{ $teacher->address }}">
                                {{ $teacher->addres }}
                            </td>
                            <td class="px-4 py-4 text-gray-700 dark:text-gray-400">{{ $teacher->phone }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
