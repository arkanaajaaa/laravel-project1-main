      ...
      <table class="min-w-full divide-y divide-gray-200 table-auto">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th scope="col" class="px-4 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider whitespace-nowrap min-w-[100px]">
                Kelas
            </th>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr class="hover:bg-gray-50 transition-colors duration-200">
              ...
              <td class="px-4 py-4 text-sm text-gray-700 max-w-[250px] truncate" title="{{ $student['address'] }}">
                  {{ $student->address }}
              </td>
              <td class="px-4 py-4 text-sm text-gray-700 whitespace-nowrap">
                  {{ $student->phone }}
