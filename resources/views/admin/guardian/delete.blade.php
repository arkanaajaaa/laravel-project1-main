<div id="deleteGuardianModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <button id="closeDeleteGuardianBtn" type="button"
            ...
            <svg class="text-gray-400 dark:text-gray-500 w-11 h-11 mb-3.5 mx-auto" 
                ...
                <path fill-rule="evenodd"
                    d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0-1-1z"
                    clip-rule="evenodd"></path>
            </svg>
            ...
            <form id="deleteGuardianForm" method="POST" action="">
                @csrf
                @method('DELETE')
                <div class="flex justify-center items-center space-x-4">
                    <button type="button" id="cancelDeleteGuardianBtn"
                    ...
                    <button type="submit"
                        ...
                        hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 
